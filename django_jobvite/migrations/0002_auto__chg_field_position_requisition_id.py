...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Position.requisition_id'
        db.alter_column('django_jobvite_position', 'requisition_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Position.requisition_id'
        db.alter_column('django_jobvite_position', 'requisition_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
    models = {
        ...
        'django_jobvite.position': {
            ...
            'requisition_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
